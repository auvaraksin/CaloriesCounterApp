Приложение CaloriesCounterAppApplication является демонстрационным и может быть использовано
исключительно с целью показать возможности и способы применения JAVA17 и инструментов из состава
...
сервиса REST API необходимо использовать коллекцию запросов Postman
